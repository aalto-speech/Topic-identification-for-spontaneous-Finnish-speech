    ...
    def transcribe_dataset(
        ...
        with torch.no_grad():
            ...
            for batch in dataset:
                ...
                with open("output/predictions_9_dev.txt", "a") as f:
...
def data_prep(data_folder, bert_model, bert_tokenizer, asr_brain, hparams):
    ...
    train_data = sb.dataio.dataset.DynamicItemDataset.from_json(json_path=os.path.join(data_folder, "train_whole.json"), replacements={"data_root": data_folder})
